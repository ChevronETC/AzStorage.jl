...
int BUFFER_SIZE = 16000; // this needs to be large to accomodate large OAuth2 tokens
...
struct PerfCounters {
    long long msWaitThrottled;
    long long msWaitTimeout;
    long long countThrottled;
    long long countTimeouts;
};
